...
pub(crate) const KEYTRANS_SIGNING_KEY_MATERIAL_DEV: &[u8; 32] =
    // FLT(uoemai): Generated by KT server.
    &hex!("5ff55ca989e35c8d8bbdadf357681382b6a6538a325453da07155a24796c7476");
pub(crate) const KEYTRANS_VRF_KEY_MATERIAL_DEV: &[u8; 32] =
    // FLT(uoemai): Generated by KT server.
    &hex!("3eeb6580f32632e4e15690bbd558aed94d7ab45105521de3ddc761e6d4f9cbaf");
pub(crate) const KEYTRANS_AUDITOR_KEY_MATERIAL_DEV: &[u8; 32] =
    // FLT(uoemai): Copied from staging.
    &hex!("1123b13ee32479ae6af5739e5d687b51559abf7684120511f68cde7a21a0e755");

pub(crate) const KEYTRANS_CONFIG_DEV: KeyTransConfig = KeyTransConfig {
    signing_key_material: KEYTRANS_SIGNING_KEY_MATERIAL_DEV,
    vrf_key_material: KEYTRANS_VRF_KEY_MATERIAL_DEV,
    auditor_key_material: KEYTRANS_AUDITOR_KEY_MATERIAL_DEV,
};
...
pub const DEV: Env<'static> = Env {
    ...
    keytrans_config: KEYTRANS_CONFIG_DEV,
};
